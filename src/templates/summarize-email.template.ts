export class SummarizeEmailTemplate {
  static generate(summary: string, originalContent: string): string {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  static plainText(summary: string, originalContent: string): string {
    return `
CONTENT SUMMARY
===============
